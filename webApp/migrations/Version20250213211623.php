 ...
 */
final class Version20250213211623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE besoin (id SERIAL NOT NULL, client_id UUID NOT NULL, libelle VARCHAR(255) NOT NULL, date DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_8118E81119EB6921 ON besoin (client_id)');
        $this->addSql('COMMENT ON COLUMN besoin.client_id IS \'(DC2Type:uuid)\'');
        $this->addSql('CREATE TABLE competence (id SERIAL NOT NULL, type VARCHAR(2) NOT NULL, libelle VARCHAR(50) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id UUID NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
